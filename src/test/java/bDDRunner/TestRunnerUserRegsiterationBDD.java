...
@CucumberOptions(features = "src\\test\\java\\businessFeatures\\UserRegisterationFromBDDApproach.feature"
,glue = "stepDefinitions"
,plugin = {"pretty" , "html:target/cucumber-html-report"})
public class TestRunnerUserRegsiterationBDD extends TestBase {
